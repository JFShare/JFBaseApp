...
public class BottomBar extends LinearLayout {
    ...
    public BottomBar addItem(final BottomBarTab tab) {
        tab.setOnClickListener(v -> {
            ...
            if (mCurrentPosition == pos) {
                ...
                if (mListener.onTabSelected(pos, mCurrentPosition)) {
    ...
    public void setBackground(@DrawableRes int res) {
        mTabLayout.setBackgroundResource(res);
    }
    ...
    public interface OnTabSelectedListener {
        boolean onTabSelected(int position, int prePosition);
...
//     navigationBar.setOnTabSelectedListener(object : BottomBar.OnTabSelectedListener {
