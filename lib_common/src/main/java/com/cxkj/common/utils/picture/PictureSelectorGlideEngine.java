...
public class PictureSelectorGlideEngine implements ImageEngine {
    ...
    private PictureSelectorGlideEngine() {
    }

    private static PictureSelectorGlideEngine instance;

    public static PictureSelectorGlideEngine createGlideEngine() {
        if (null == instance) {
            synchronized (PictureSelectorGlideEngine.class) {
                if (null == instance) {
                    instance = new PictureSelectorGlideEngine();
                }
            }
        }
        return instance;
